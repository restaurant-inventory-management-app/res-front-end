...
export default function CategoryPage() {
  ...
  useEffect(() => {
    const url = `http://192.168.1.49:5000/api/v1/category/${categoryId}`;
    ...
    <>
      {categoryData ? (
        <div className="container-lg">
          <div>
            <svg className="back-btn" onClick={handleBackClick}
              ...
              <h1 className="text-center">{categoryData.category_name}</h1>
          </div>
